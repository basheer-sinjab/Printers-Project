...
import { i as supabase, t as cn } from "./_ssr/utils-0-yik925.mjs";
import { u as require_react } from "./_libs/@floating-ui/react-dom+[...].mjs";
import { o as require_jsx_runtime } from "./_libs/@radix-ui/react-collection+[...].mjs";
import { t as Badge } from "./_ssr/badge-CkD7adj2.mjs";
import { a as daysUntil, n as PRINTER_STATUS, r as STATUS_CLASS, s as formatDate, t as MAINTENANCE_TYPES } from "./_ssr/pms-ALghGJ54.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/_authenticated-BkWowht2.js
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						...
						children: "كل ما تحتاجه لإدارة الطابعات، في مكان واحد."
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
...
function Dashboard() {
	...
	const count = (status) => printers.filter((printer) => printer.status === status).length;
		...
		children: [
			...
			alerts.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardHeader, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardTitle, {
				...
				children: alerts.slice(0, 12).map((a, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: `rounded-xl border px-3.5 py-3 text-sm transition-transform hover:-translate-y-0.5 ${a.tone === "destructive" ? "border-destructive/30 bg-destructive/10 text-destructive" : "border-warning/40 bg-warning/15 text-warning-foreground"}`,
					children: a.text
				}, i))
			})] }),
