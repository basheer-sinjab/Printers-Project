import { t as Route } from "./printers._id-BcXlWcWe.js";
import { i as supabase } from "./utils-0-yik925.js";
import { t as Badge } from "./badge-CkD7adj2.js";
import { l as today, n as PRINTER_STATUS, r as STATUS_CLASS, s as formatDate, t as MAINTENANCE_TYPES } from "./pms-ALghGJ54.js";
import { t as PrinterImage } from "./PrinterImage-WihmddPu.js";
import { n as Input, r as Button, t as Label } from "./label-S2lCEF3z.js";
import { i as TabsTrigger, n as TabsContent, r as TabsList, t as Tabs } from "./tabs-CeyKuXzD.js";
import { a as DialogHeader, i as DialogFooter, n as Dialog, o as DialogTitle, r as DialogContent, t as Textarea } from "./textarea-B4XbONgD.js";
import { a as SelectValue, i as SelectTrigger, n as SelectContent, o as DateInput, r as SelectItem, t as Select } from "./select-Bd5-22nx.js";
import { n as useLookups, t as PrinterFormDialog } from "./PrinterFormDialog-BWxf1-GC.js";
import { a as TableHeader, i as TableHead, n as TableBody, o as TableRow, r as TableCell, t as Table } from "./table-DTHCV9bG.js";
import { useState } from "react";
import { Link, useNavigate } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { useMutation, useQuery, useQueryClient } from "@tanstack/react-query";
import { toast } from "sonner";
import { ArrowLeftRight, ArrowRight, Pencil, Plus, Star, Trash2, X } from "lucide-react";
//#region src/components/printer/TonerHistoryTab.tsx
		...
		children: [
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs(Button, {
					...
					children: [/* @__PURE__ */ jsx(Plus, { className: "size-4" }), "تسجيل تغيير حبر"]
				})
			}),
			/* @__PURE__ */ jsx("div", {
				...
				] }) }), /* @__PURE__ */ jsxs(TableBody, { children: [(history ?? []).length === 0 && /* @__PURE__ */ jsx(TableRow, { children: /* @__PURE__ */ jsx(TableCell, {
					colSpan: 5,
					className: "py-8 text-center text-muted-foreground",
					children: "لا توجد سجلات تغيير حبر."
				}) }), (history ?? []).map((r) => /* @__PURE__ */ jsxs(TableRow, { children: [
					/* @__PURE__ */ jsx(TableCell, { children: formatDate(r.change_date) }),
					/* @__PURE__ */ jsx(TableCell, { children: (r.toner_replacement_items ?? []).map((i) => i.toner_name).join("، ") || "—" }),
					/* @__PURE__ */ jsx(TableCell, { children: (r.toner_replacement_items ?? []).reduce((a, i) => a + i.quantity, 0) }),
			...
			/* @__PURE__ */ jsx(Dialog, {
				...
				children: /* @__PURE__ */ jsxs(DialogContent, {
					...
					children: [
						/* @__PURE__ */ jsx(DialogHeader, { children: /* @__PURE__ */ jsx(DialogTitle, { children: editId ? "تعديل عملية تغيير حبر" : "تسجيل عملية تغيير حبر" }) }),
						/* @__PURE__ */ jsxs("div", {
							className: "space-y-4",
							children: [
								/* @__PURE__ */ jsxs("div", {
									className: "space-y-2",
									children: [/* @__PURE__ */ jsx(Label, { children: "التاريخ" }), /* @__PURE__ */ jsx(DateInput, {
										value: date,
										onChange: setDate
									})]
								}),
								/* @__PURE__ */ jsxs("div", {
									className: "space-y-3",
									children: [
										/* @__PURE__ */ jsx(Label, { children: "الأحبار المستخدمة" }),
											...
											children: [
												/* @__PURE__ */ jsxs("div", {
													...
													children: [/* @__PURE__ */ jsxs(Select, {
														...
														children: [/* @__PURE__ */ jsx(SelectTrigger, { children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "اختر الحبر" }) }), /* @__PURE__ */ jsxs(SelectContent, { children: [(toners ?? []).map((t) => /* @__PURE__ */ jsxs(SelectItem, {
															value: t.id,
															children: [
																t.name,
																" (متوفر: ",
													...
													}), item.tonerId === CUSTOM && /* @__PURE__ */ jsx(Input, {
														className: "mt-2",
										...
										/* @__PURE__ */ jsxs(Button, {
											...
											children: [/* @__PURE__ */ jsx(Plus, { className: "size-4" }), "إضافة حبر آخر"]
										})
									]
								}),
								/* @__PURE__ */ jsxs("div", {
									className: "space-y-2",
									children: [/* @__PURE__ */ jsx(Label, { children: "ملاحظات" }), /* @__PURE__ */ jsx(Textarea, {
										rows: 2,
										value: notes,
...
//#endregion
//#region src/components/printer/MaintenanceTab.tsx
		...
		children: [
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs(Button, {
					...
					children: [/* @__PURE__ */ jsx(Plus, { className: "size-4" }), "إضافة صيانة"]
				})
			}),
			/* @__PURE__ */ jsx("div", {
				className: "surface-panel overflow-hidden",
				children: /* @__PURE__ */ jsxs(Table, { children: [/* @__PURE__ */ jsx(TableHeader, { children: /* @__PURE__ */ jsxs(TableRow, { children: [
				...
				] }) }), /* @__PURE__ */ jsxs(TableBody, { children: [(records ?? []).length === 0 && /* @__PURE__ */ jsx(TableRow, { children: /* @__PURE__ */ jsx(TableCell, {
					colSpan: 6,
					className: "py-8 text-center text-muted-foreground",
					children: "لا توجد سجلات صيانة."
				}) }), (records ?? []).map((r) => /* @__PURE__ */ jsxs(TableRow, { children: [
					/* @__PURE__ */ jsx(TableCell, { children: formatDate(r.service_date) }),
					/* @__PURE__ */ jsx(TableCell, { children: MAINTENANCE_TYPES[r.maintenance_type] }),
					/* @__PURE__ */ jsx(TableCell, {
					...
					/* @__PURE__ */ jsx(TableCell, { children: /* @__PURE__ */ jsx("div", {
						...
						children: (r.replaced_parts ?? []).length === 0 ? "—" : r.replaced_parts.map((p) => /* @__PURE__ */ jsx(Badge, {
							variant: "secondary",
							children: p
						}, p))
					}) }),
			...
			/* @__PURE__ */ jsx(Dialog, {
				...
				children: /* @__PURE__ */ jsxs(DialogContent, {
					className: "max-h-[90vh] max-w-2xl overflow-y-auto",
					children: [
						/* @__PURE__ */ jsx(DialogHeader, { children: /* @__PURE__ */ jsx(DialogTitle, { children: editId ? "تعديل سجل صيانة" : "إضافة سجل صيانة" }) }),
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs("div", {
									className: "space-y-2",
									children: [/* @__PURE__ */ jsx(Label, { children: "نوع الصيانة" }), /* @__PURE__ */ jsxs(Select, {
										value: type,
										onValueChange: (v) => setType(v),
										children: [/* @__PURE__ */ jsx(SelectTrigger, { children: /* @__PURE__ */ jsx(SelectValue, {}) }), /* @__PURE__ */ jsx(SelectContent, { children: Object.entries(MAINTENANCE_TYPES).map(([k, v]) => /* @__PURE__ */ jsx(SelectItem, {
											value: k,
											children: v
										}, k)) })]
									})]
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx(Label, { children: "الوصف" }), /* @__PURE__ */ jsx(Textarea, {
										rows: 3,
										value: description,
								...
								/* @__PURE__ */ jsxs("div", {
									className: "space-y-2",
									children: [/* @__PURE__ */ jsx(Label, { children: "الفني" }), /* @__PURE__ */ jsx(Input, {
										value: technician,
								...
								/* @__PURE__ */ jsxs("div", {
									className: "space-y-2 sm:col-span-2",
									children: [
										/* @__PURE__ */ jsx(Label, { children: "القطع المستبدلة" }),
										/* @__PURE__ */ jsx("div", {
											className: "flex flex-wrap gap-2",
											children: selectedParts.map((p) => /* @__PURE__ */ jsxs(Badge, {
												variant: "secondary",
												className: "gap-1",
										...
										/* @__PURE__ */ jsxs(Select, {
											...
											children: [/* @__PURE__ */ jsx(SelectTrigger, { children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "اختر قطعة من المكتبة" }) }), /* @__PURE__ */ jsx(SelectContent, { children: (parts ?? []).map((p) => /* @__PURE__ */ jsx(SelectItem, {
												value: p.name,
												children: p.name
											}, p.id)) })]
										}),
...
//#endregion
//#region src/components/printer/TransfersTab.tsx
		...
		children: [
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs(Button, {
					...
					children: [/* @__PURE__ */ jsx(ArrowLeftRight, { className: "size-4" }), "نقل الطابعة"]
				})
			}),
			/* @__PURE__ */ jsx("div", {
				className: "surface-panel overflow-hidden",
				...
				] }) }), /* @__PURE__ */ jsxs(TableBody, { children: [(transfers ?? []).length === 0 && /* @__PURE__ */ jsx(TableRow, { children: /* @__PURE__ */ jsx(TableCell, {
					colSpan: 4,
					className: "py-8 text-center text-muted-foreground",
					children: "لا توجد عمليات نقل."
				}) }), (transfers ?? []).map((t) => /* @__PURE__ */ jsxs(TableRow, { children: [
					/* @__PURE__ */ jsx(TableCell, { children: formatDate(t.transfer_date) }),
					/* @__PURE__ */ jsxs(TableCell, { children: [t.old_department || "—", /* @__PURE__ */ jsx("div", {
						className: "text-xs text-muted-foreground",
						children: t.old_person || "—"
					})] }),
					/* @__PURE__ */ jsxs(TableCell, { children: [t.new_department || "—", /* @__PURE__ */ jsx("div", {
						className: "text-xs text-muted-foreground",
			...
			/* @__PURE__ */ jsx(Dialog, {
				...
				children: /* @__PURE__ */ jsxs(DialogContent, {
					className: "max-w-lg",
					children: [
						/* @__PURE__ */ jsx(DialogHeader, { children: /* @__PURE__ */ jsx(DialogTitle, { children: "نقل الطابعة" }) }),
						/* @__PURE__ */ jsxs("div", {
							className: "space-y-4",
							children: [
								/* @__PURE__ */ jsxs("div", {
									className: "space-y-2",
									children: [/* @__PURE__ */ jsx(Label, { children: "تاريخ النقل" }), /* @__PURE__ */ jsx(DateInput, {
										value: date,
										onChange: setDate
									})]
								}),
								...
								/* @__PURE__ */ jsxs("div", {
									className: "space-y-2",
									children: [/* @__PURE__ */ jsx(Label, { children: "سبب النقل" }), /* @__PURE__ */ jsx(Textarea, {
										rows: 2,
										value: reason,
...
function Picker({ label, value, onChange, options }) {
	return /* @__PURE__ */ jsxs("div", {
		className: "space-y-2",
		children: [/* @__PURE__ */ jsx(Label, { children: label }), /* @__PURE__ */ jsxs(Select, {
			value,
			onValueChange: onChange,
			children: [/* @__PURE__ */ jsx(SelectTrigger, { children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "اختر" }) }), /* @__PURE__ */ jsx(SelectContent, { children: (options ?? []).map((o) => /* @__PURE__ */ jsx(SelectItem, {
				value: o.id,
				children: o.name
			}, o.id)) })]
		})]
...
//#endregion
//#region src/routes/_authenticated/printers.$id.tsx?tsr-split=component
function PrinterDetails() {
	...
	if (!printer) return /* @__PURE__ */ jsxs("div", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(Link, {
						...
						children: [printer.name, /* @__PURE__ */ jsx(Badge, {
							variant: "outline",
					...
					children: [
						/* @__PURE__ */ jsxs(Button, {
							...
							children: [/* @__PURE__ */ jsx(Star, { className: `size-4 ${printer.is_favorite ? "fill-warning text-warning" : ""}` }), printer.is_favorite ? "إزالة من المفضلة" : "إضافة للمفضلة"]
						}),
						/* @__PURE__ */ jsxs(Button, {
							variant: "outline",
							className: "gap-2",
							onClick: () => setEditOpen(true),
							children: [/* @__PURE__ */ jsx(Pencil, { className: "size-4" }), "تعديل"]
						}),
						/* @__PURE__ */ jsxs(Button, {
							variant: "outline",
							...
							children: [/* @__PURE__ */ jsx(Trash2, { className: "size-4" }), "حذف"]
						})
					]
				})]
			}),
			/* @__PURE__ */ jsxs(Tabs, {
				...
				children: [
					...
					/* @__PURE__ */ jsx(TabsContent, {
						...
						children: /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsx(PrinterImage, {
								...
								children: info.map(([label, value]) => /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("dt", {
									className: "text-xs text-muted-foreground",
									children: label
								}), /* @__PURE__ */ jsx("dd", {
					...
					/* @__PURE__ */ jsx(TabsContent, {
						value: "toner",
						className: "mt-4",
						children: /* @__PURE__ */ jsx(TonerHistoryTab, { printerId: printer.id })
					}),
					/* @__PURE__ */ jsx(TabsContent, {
						value: "maintenance",
						className: "mt-4",
						children: /* @__PURE__ */ jsx(MaintenanceTab, { printerId: printer.id })
					}),
					/* @__PURE__ */ jsx(TabsContent, {
						value: "transfers",
						className: "mt-4",
						children: /* @__PURE__ */ jsx(TransfersTab, { printer })
					})
				]
			}),
